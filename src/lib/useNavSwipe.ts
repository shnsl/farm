...
/**
 * Mobilde yatay kaydırma ile üst menü sayfaları arasında geçiş.
 * Alan detayı gibi menü dışı rotalarda ve yatay kaydırılabilir alanlarda kapalıdır.
 */
export function useNavSwipe(enabled = true) {
  ...
  useEffect(() => {
    ...
    function onTouchEnd(e: TouchEvent) {
      ...
      // Sola kaydır → sonraki menü; sağa kaydır → önceki menü
